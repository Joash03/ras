      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('team.create') }}" class="btn btn-outline-primary ms-2">
                Add Team
              </a>
            </div>
          </div> <!-- / .row -->
              ...
              <table class="table table-sm table-hover table-nowrap card-table">
                <thead>
                  <tr>
                    ...
                    <th>
                      <a class="list-sort text-muted" data-sort="item-name">Designation</a>
                    </th>
                    <th>
                ...
                <tbody class="list fs-base">
                    @if ($teams->isEmpty())
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Team List is Empty!</td>
                            <td></td>
                            <td></td>
                        </tr>
                    @else
                        ...
                        <tr>
                            ...
                            <div class="avatar avatar-sm align-middle me-2">
                                <img class="avatar-img rounded" src="{{ (!empty($item->thumbnail)) ? url('uploads/team_images/'.$item->thumbnail) : url('uploads/no_image.jpg') }}" alt="{{ $item->name }}">
                            </td>
                            <td>
                            <!-- Text -->
                            ...
                            <td>
                            <!-- Text -->
                            <a class="item-name text-reset">{{ ($item->designation) }}</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center ">
                                    ...
                                    <span style="margin-right: 5px">
                                        <!-- Button -->
                                        <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('team.edit', $item->id) }}">
                                            <span class="fe fe-edit"></span>
                                        </a>
                                    </span>
                                    @endif
                                    @if(Auth::user()->can('team.destroy'))
                                    <form method="POST" action="{{ route('team.destroy', $item->id) }}" data-confirm-delete="true" data-id="{{ $item->id }}">
                                        @csrf
                                        @method('DELETE')
