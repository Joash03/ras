        ...
        <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel" aria-labelledby="contactsListTab">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Form -->
              <form class="mb-4" action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data"  onsubmit="return validateForm();">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <!-- Label -->
                            <label class="form-label mb-1" for="thumbnailCreate">Team Thumbnail</label>
                            <!-- Input -->
