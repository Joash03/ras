      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('employee.role.add') }}" class="btn btn-outline-primary ms-2">Add Employe Role</a>
            </div>
          </div> <!-- / .row -->
        </div>
      </div>
                  ...
                  <tbody class="list fs-base">
                    @if ($employees->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Employee Role List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                          ...
                          <td>
                              <div class="d-flex align-items-center ">
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('employee.role.edit', $item->id) }}">
                                          <span class="fe fe-edit"></span>
                                      </a>
                                  </span>
                                  <form method="POST" action="{{ route('employee.role.detach', $item->id) }}" data-confirm-delete="true"
                                      data-id="{{ $item->id }}">
                                      @csrf
