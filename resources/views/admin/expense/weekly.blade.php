...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-12">
        ...
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <!-- Title -->
              <h1 class="header-title text-truncate"> {{ date("d", strtotime("-1 week")) }} to {{ date("d F Y", strtotime("-1 day")) }} {{ $page_title }}
              </h1>
      ...
      @php
      $totalexpense = App\Models\Expense::wherebetween('date',[$startDate, $endDate])->sum('amount');
