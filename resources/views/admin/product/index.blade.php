      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('product.import') }}" class="btn btn-outline-dark ms-2" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Import Product">
                ...
                <tbody class="list fs-base">
                    ...
                    @else
                        ...
                        <tr>
                            ...
                            <td>
                            <!-- Price -->
                            </div> <a class="item-name text-reset">#{{ $item->sales_price }}</a>
                            </td>
                            <td>
                            <!-- Text -->
                            <a class="item-name text-reset">{{ $item->stock }}</a>
                            </td>
                            <td>
                            <div class="d-flex align-items-center ">
                                <span style="margin-right: 5px" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View">
                                    <!-- Button -->
                                    <button class="btn btn-outline-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modalProductDetails{{ $item->id }}">
                                ...
                                <div class="modal fade" id="modalProductDetails{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modalProductDetails{{ $item->id }}Label" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <img src="{{ (!empty($item->thumbnail)) ? url('uploads/product_images/'.$item->thumbnail) : url('uploads/no_image.jpg') }}" alt="{{ $item->name }}" class="avatar-img rounded" style="max-width: 90%; ">
                                                </a>
                                                <div class="row p-4">
                                                <!-- Prettitle -->
                                        ...
                                        <div class="col-12 col-md-7">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                                    <h4 class="fw-normal mb-1">Stock Status</h4> <h4 class="fw-normal mb-1"><span class="item-score badge {{ $item->stock_status == 0 ? ' bg-danger-soft':($item->stock_status == 1 ? ' bg-success-soft':'bg-danger-soft') }}">{{ $item->stock_status == 0 ? 'Out of Stock':($item->stock_status == 1 ? 'In Stock':'Expired') }}</span></h4>
                                                    </li>
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                                    ...
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                                    <h4 class="fw-normal mb-1">Expiry date</h4> <h4 class="fw-normal mb-1">{{ $item->expiry_date }}</h4>
                                                    </li>
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                                    <h4 class="fw-normal mb-1">Purchase price</h4> <h4 class="fw-normal mb-1">#{{ $item->purchase_price }}</h4>
                                                    </li>
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                                    <h4 class="fw-normal mb-1">Sales price</h4> <h4 class="fw-normal mb-1">#{{ $item->sales_price }}</h4>
                                                    </li>
                                                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                                ...
                                <span style="margin-right: 5px">
                                    <!-- Button -->
                                    <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('product.edit', $item->id) }}">
                                        <span class="fe fe-edit"></span>
                                    </a>
                                </span>
                                @endif
                                @if(Auth::user()->can('product.destroy'))
                                <form method="POST" action="{{ route('product.destroy', $item->id) }}" data-confirm-delete="true" data-id="{{ $item->id }}">
                                @csrf
                                @method('DELETE')
