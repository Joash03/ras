        ...
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <!-- Title -->
              <h1 class="header-title text-truncate">Supplier Index</h1>
            </div>
            <div class="col-auto">
              <!-- Buttons -->
              ...
              <table class="table table-sm table-hover table-nowrap card-table">
                  <thead>
                      <tr>
                          ...
                          <th>
                              <a class="list-sort text-muted" data-sort="item-title">Email</a>
                          </th>
                          <th>
                  ...
                  <tbody class="list fs-base">
                    @if ($suppliers->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Supplier List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <div class="avatar avatar-sm align-middle me-2">
                                  <img class="avatar-img rounded" src="{{ (!empty($item->photo)) ? url('uploads/supplier_images/'.$item->photo) : url('uploads/no_image.jpg') }}"
                                      alt="{{ $item->name }}">
                              </div>
                          </td>
                          <td>
                          ...
                          <td>
                              <!-- Text -->
                              <a class="item-name text-reset">{{ $item->email }}</a>
                          </td>
                          <td>
                              <!-- Text -->
                          ...
                          <td>
                              <!-- Type Badge -->
                              <span class="item-score badge {{ $item->type == 'wholesaler' ? 'bg-info-soft' : 'bg-danger-soft' }}">{{ $item->type == 'wholesaler' ? 'Wholesaler' : 'Distributor' }}</span>
                          </td>
                          <td>
                              <div class="d-flex align-items-center ">
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View" href="{{ route('supplier.details', $item->id) }}">
                                  ...
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('supplier.edit', $item->id) }}">
                                          <span class="fe fe-edit"></span>
                                      </a>
                                  </span>
                                  @endif
                                  @if(Auth::user()->can('supplier.delete'))
                                  <form method="POST" action="{{ route('supplier.delete', $item->id) }}" data-confirm-delete="true"
                                      data-id="{{ $item->id }}">
                                      @csrf
                                      @method('DELETE')
