              ...
              <table class="table table-sm table-hover table-nowrap card-table">
                <thead>
                  <tr>
                    ...
                    <th>
                      <a class="list-sort text-muted" data-sort="item-name">Description</a>
                    </th>
                    <th>
                ...
                <tbody class="list fs-base">
                    @if ($services->isEmpty())
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Services List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                    @else
                        ...
                        <tr>
                            ...
                            <div class="avatar avatar-sm align-middle me-2">
                                <img class="avatar-img rounded" src="{{ (!empty($item->thumbnail)) ? url('uploads/service_images/'.$item->thumbnail)
                            ...
                            <td>
                                <div class="d-flex align-items-center ">
                                    ...
                                    <span style="margin-right: 5px">
                                        <!-- Button -->
                                        <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('service.edit', $item->id) }}">
                                            <span class="fe fe-edit"></span>
                                        </a>
                                    </span>
                                    @endif
                                    @if(Auth::user()->can('service.destroy'))
                                    <form method="POST" action="{{ route('service.destroy', $item->id) }}" data-confirm-delete="true"
                                        data-id="{{ $item->id }}">
                                        @csrf
                                        @method('DELETE')
