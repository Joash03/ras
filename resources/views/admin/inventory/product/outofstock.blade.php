  ...
  <div class="row justify-content-center">
    <div class="col-12">
      ...
      <div class="tab-content pb-6">
                    ...
                    <tbody class="list fs-base">
                        @if ($outofstockproducts->isEmpty())
                            <tr>
                                <td></td>
                                <td></td>
                                <td  class="item-name h4 text-center">Out of Stock List is Empty!</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                        @else
                            ...
                            <tr>
                                ...
                                <td>
                                <!-- Stock -->
                                <p class="item-name text-danger"><strong>{{ $item->stock }}</strong>
                                </p>
                                </td>
                            </tr>
                            @endforeach
        ...
        <form class="tab-content {{ $step2 }}" action="{{ route('inventory.product.outofstock.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Card -->
            <div class="card" data-list='{"valueNames": ["item-name", "item-title", "item-email", "item-phone", "item-score", "item-company"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsList">
                <div class="card-header">
                    ...
                    <tbody class="list fs-base">
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td >
                                <!-- Stock -->
                                <a class="item-name text-danger"><strong>{{ $item->stock }}</strong>
                                </a>
                                </td>
                                <td>
                                <!-- Stock -->
                                <a class="item-name text-reset">
                                    <input type="number" name="new_stock[{{ $item->id }}]" class="form-control">
                                </a>
                                </td>
                            </tr>
                            @endforeach
