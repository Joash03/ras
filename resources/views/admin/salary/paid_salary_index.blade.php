            ...
            <div class="table-responsive">
              <table class="table table-sm table-hover table-nowrap card-table">
                  ...
                  <tbody class="list fs-base">
                    @if ($paidSalary->isEmpty())
                        <tr>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Paid Salary List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                    @else
                      ...
                      <tr>
                          ...
                          <td>
                            <!-- Status Badge -->
                            <span class="item-score badge bg-info-soft">Fully Paid</span>
                          </td>
                          <td>
                            <div class="d-flex align-items-center ">
                                <span style="margin-right: 5px">
                                    <!-- Button -->
                                    <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Salary History" href="{{ route('salary.pay.history', $item->employee_id) }}">
