      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('customer.add') }}" class="btn btn-primary ms-2">Create Customer</a>
            </div>
          </div> <!-- / .row -->
        </div>
      </div>
                  ...
                  <tbody class="list fs-base">
                    @if ($customers->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Customer List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <div class="avatar avatar-sm align-middle me-2">
                                  <img class="avatar-img rounded" src="{{ (!empty($item->photo)) ? url('uploads/customer_images/'.$item->photo) : url('uploads/no_image.jpg') }}"
                                      alt="{{ $item->name }}">
                              </div>
                          </td>
                          <td>
                          ...
                          <td>
                              ...
                              <div class="d-flex align-items-center ">
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View" href="{{ route('customer.details', $item->id) }}">
                                  ...
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('customer.edit', $item->id) }}">
                                          <span class="fe fe-edit"></span>
                                      </a>
                                  </span>
                                  @endif
                                  @if(Auth::user()->can('customer.delete'))
                                  <form method="POST" action="{{ route('customer.delete', $item->id) }}" data-confirm-delete="true"
                                      data-id="{{ $item->id }}">
                                      @csrf
                                      @method('DELETE')
