          ...
          <div class="header-body">
            <div class="row align-items-center">
              ...
              <div class="col-auto">
                ...
                <a class="btn btn-primary ms-2" href="{{ route('pos.index') }}">
                    <span class="fe fe-arrow-left-circle"></span> Return to POS
                </a>
              </div>
            </div> <!-- / .row -->
          </div>
            ...
            <div class="col-12 col-lg-10">
                <div class="bg-white p-5">
                    <div class="row">
                        ...
                        <!-- Text -->
                        <p class="text mb-4">
                            Invoice Reference <span>{{ $order->reference }}</span>
                        </p>
                        </div>
                    </div> <!-- / .row -->
                    <div class="row mb-4">
                        <div class="col-12 col-md-6">
                            ...
                            <!-- Text -->
                            <p class="text mb-2">
                                Customer Name: <strong class="text-body">{{ $user->name }}</strong> <br>
                            </p>
                            <p class="text mb-2">
                                Phone Number : <strong class="text-body">{{ $user->email }}</strong><br>
                            </p>
                            <p class="text mb-2">
