        ...
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <!-- Title -->
              <h1 class="header-title text-truncate">Role Permissions Index</h1>
            </div>
            <div class="col-auto">
              <!-- Buttons -->
              ...
              <table class="table table-sm table-hover table-nowrap card-table">
                  ...
                  <tbody class="list fs-base">
                    @if ($roles->isEmpty())
                        <tr>
                            <td></td>
                            <td  class="item-name h4 text-center">Role Permission List is Empty!</td>
                            <td></td>
                            <td></td>
                        </tr>
                    @else
                          ...
                          <td>
                            <div class="d-flex flex-wrap">
                              @foreach($item->permissions as $permission)
                                <!-- Type Badge -->
                                <span class="item-score badge bg-dark-soft" style="margin-right: 8px; margin-bottom: 8px; line-height: 1.5;">{{ $permission->name }}</span>
                              @endforeach
                            </div>
                          </td>
                          <td>
                              <div class="d-flex align-items-center ">
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('role.permission.edit', $item->id) }}">
                                          <span class="fe fe-edit"></span>
                                      </a>
                                  </span>
                                  <form method="POST" action="{{ route('role.permission.delete', $item->id) }}" data-confirm-delete="true"
                                      data-id="{{ $item->id }}">
                                      @csrf
                                      @method('DELETE')
