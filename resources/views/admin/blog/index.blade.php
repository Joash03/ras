      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('blog.create') }}" class="btn btn-outline-primary ms-2">
                Add Blog
              </a>
              ...
              <table class="table table-sm table-hover table-nowrap card-table">
                <thead>
                  <tr>
                    ...
                    <th>
                      <a class="list-sort text-muted" data-sort="item-title" >Title</a>
                    </th>
                    <th>
                      <a class="list-sort text-muted" data-sort="item-name" >Category</a>
                    </th>
                    <th>
                      <a class="list-sort text-muted" data-sort="item-name" >Author</a>
                    </th>
                    <th>
                ...
                <tbody class="list fs-base">
                    @if ($blogs->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Blog List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                    @else
                        ...
                        <tr>
                            ...
                            <div class="avatar avatar-sm align-middle me-2">
                                <img class="avatar-img rounded" src="{{ (!empty($item->thumbnail)) ? url('uploads/blog_images/'.$item->thumbnail)
                            ...
                            <td>
                            <!-- Price -->
                            </div> <a class="item-name text-reset">{{ $item->user->name }}</a>
                            </td>
                            <td>
                            <!-- Status Badge -->
                            ...
                            <td>
                                <div class="d-flex align-items-center ">
                                    ...
                                    <span style="margin-right: 5px">
                                        <!-- Button -->
                                        <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('blog.edit', $item->id) }}">
                                            <span class="fe fe-edit"></span>
                                        </a>
                                    </span>
                                    @endif
                                    @if(Auth::user()->can('blog.destroy'))
                                    <form method="POST" action="{{ route('blog.destroy', $item->id) }}" data-confirm-delete="true"
                                        data-id="{{ $item->id }}">
                                        @csrf
                                        @method('DELETE')
