                ...
                <tbody class="list fs-base">
                    @if ($reservations->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Order History is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center ">
                                @php
                                    $buttunstatus = $item->status;
                                    $buttonhidedelete = '';
                                    $buttonhidecomfirm = '';
                                    if ($buttunstatus === 0) {
                                        $buttonhidedelete = 'd-none';
                                    }elseif ($buttunstatus === 2) {
                                        $buttonhidecomfirm = 'd-none';
                                    }
                                @endphp
                                ...
                                <form method="POST" action="{{ route('reserve.delete', $item->id) }}" data-confirm-delete="true" data-id="{{ $item->id }}">
                                @csrf
                                @method('DELETE')
