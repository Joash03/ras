        ...
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col">
              ...
              <!-- Title -->
              <h1 class="header-title">Create New Employee</h1>
            </div>
          </div> <!-- / .row -->
        </div>
      </div>
        ...
        <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel" aria-labelledby="contactsListTab">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Form -->
              <form class="mb-4" action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm();">
                @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Input -->
                        <input type="date" name="dob" id="dob" class="form-control flatpickr-input" data-flatpickr="">
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <!-- Religion -->
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <!-- Input -->
                      <input type="number" id="salary" name="salary" class="form-control mb-3" placeholder="#0.00" >
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <!-- Appointment date -->
                    <div class="form-group">
                        ...
                        <!-- Input -->
                        <input type="date" name="appointment_date" id="appointment_date" class="form-control flatpickr-input" data-flatpickr="">
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <!-- Employee photo -->
                    <div class="form-group">
                      <!-- Label  -->
                      <label class="form-label mb-1" for="photoCreate">Employee Photo</label>
                      <!-- Input -->
  ...
  function validateForm() {
    ...
    if (qualification === '') {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Qualification field is required!',
        });
        return false; // Prevent form submission
    }
    if (dob === '') {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Date of birth field is required!',
        });
        return false; // Prevent form submission
    }
    if (next_kin === '') {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Next of Kin field is required!',
        });
        return false; // Prevent form submission
    }
    if (salary === '') {
