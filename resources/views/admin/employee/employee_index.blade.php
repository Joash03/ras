      ...
      <div class="header">
        <div class="header-body">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <!-- Buttons -->
              <a href="{{ route('employee.add') }}" class="btn btn-outline-primary ms-2">Add Employee</a>
            </div>
          </div> <!-- / .row -->
        </div>
      </div>
                  ...
                  <tbody class="list fs-base">
                    @if ($employees->isEmpty())
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="item-name h4 text-center">Employee List is Empty!</td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <div class="avatar avatar-sm align-middle me-2">
                                  <img class="avatar-img rounded" src="{{ (!empty($item->photo)) ? url('uploads/employee_images/'.$item->photo) : url('uploads/no_image.jpg') }}"
                                      alt="{{ $item->name }}">
                              </div>
                          </td>
                          <td>
                          ...
                          <td>
                              <div class="d-flex align-items-center ">
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View" href="{{ route('employee.details', $item->id) }}">
                                  ...
                                  <span style="margin-right: 5px">
                                      <!-- Button -->
                                      <a class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="{{ route('employee.edit', $item->id) }}">
                                          <span class="fe fe-edit"></span>
                                      </a>
                                  </span>
                                  @endif
                                  @if(Auth::user()->can('employee.delete'))
                                  <form method="POST" action="{{ route('employee.delete', $item->id) }}" data-confirm-delete="true"
                                      data-id="{{ $item->id }}">
                                      @csrf
                                      @method('DELETE')
