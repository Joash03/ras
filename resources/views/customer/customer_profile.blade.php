                ...
                <div class="row align-items-end">
                  <div class="col-auto">
                    ...
                    <div class="avatar avatar-xxl header-avatar-top">
                      <img src="{{ (!empty($profileData->photo)) ? url('uploads/customer_images/'.$profileData->photo) : url('uploads/no_image.jpg') }}" alt="photo" class="avatar-img rounded">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-auto mt-2 mb-md-3">
                    <!-- Button -->
                    <a href="#editProfile" class="btn btn-outline-primary ms-2">Edit Profile</a>
                    <!-- Button -->
                    <a href="{{ route('customer.change.password') }}" class="btn btn-outline-primary ms-2">Change Password</a>
                  </div>
                </div> <!-- / .row -->
                ...
                <div class="container-fluid" id="editProfile">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <!-- Form -->
                        <form class="mb-4" method="POST" action="{{ route('customer.profile.store') }}" enctype="multipart/form-data" onsubmit="return validateForm();">
                            @csrf
