                      ...
                      <tr>
                        <td align="left" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; padding-bottom: 16px;" valign="top">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                            <tbody>
                              <tr>
                                <td style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #3085d6;" valign="top" align="center" bgcolor="#3085d6"> <a href="{{ route('register') }}" target="_blank" style="border: solid 2px #3085d6; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 10px 18px; text-decoration: none; text-transform: capitalize; background-color: #3085d6; border-color: #3085d6; color: #ffffff;">Sign Up</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
