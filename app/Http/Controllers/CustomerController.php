...
class CustomerController extends Controller
{
    ...
    public function CustomerDashboard(Request $request)
    {
        ...
        return view('customer.index', compact('date', 'pendingorders', 'totalorders', 'totalpendingorders'));
    }// End Method
    ...
    public function ProfileStore(Request $request)
    {
        ...
        if ($request->file('photo')) {
            ...
            @unlink(public_path('uploads\\customer_images\\' . $formData->photo));
    ...
    public function CustomerOrderHistory()
    {
        ...
        return view('customer.order.history', compact('page_title', 'orders', 'orderdetails'));
    }// End Method
    // End Order Method


    // Start Invoice Method
    public function CustomerCreateInvoice($id)
    {
        ...
        return view('customer.invoice.index', compact('page_title', 'order', 'customer', 'orderdetails'));
